...
def test_both_locations_render():
    html = render_comparison({"Meadowvale": _MEADOWVALE, "Harborview": _HARBORVIEW})
    assert "Meadowvale" in html and "Harborview" in html
...
def test_missing_blocks_do_not_crash():
    html = render_comparison({"Meadowvale": {}, "Harborview": {}})
    assert "Meadowvale" in html and "Harborview" in html
